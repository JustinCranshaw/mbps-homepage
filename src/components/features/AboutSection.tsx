    ...
    <Section id="about" variant="mist" elevation="above">
      <div className="section-header text-center">
          ...
          <p className="section-lede max-w-3xl mx-auto">
            We are a unique Waldorf cooperative in Seattle's Mount Baker neighborhood. Our days flow with gentle
        ...
        <div className="about-two-col">
          ...
          <div className="philosophy-text">
            ...
            <p className="body-text mb-4">
              As a true cooperative, families are active participants in their child's education. Parents spend time in the classroom, creating a rich learning environment where children experience multiple caring adults as part of their extended community.
            </p>
        ...
        <div className="about-two-col" style={{ marginTop: 24 }}>
          ...
          <div className="philosophy-text">
            ...
            <p className="body-text mb-3">
              <span className="label">Location</span>: Seattle's Mount Baker neighborhood, where tree‑lined streets and parks extend our classroom outdoors.
            </p>
            <p className="body-text">
        ...
        <div className="about-two-col" style={{ marginTop: 24 }}>
          <div className="philosophy-text">
            ...
            <ul className="body-text space-y-2">
              <li><span className="label">9am:</span> Arrival, outdoor play, circle, walk</li>
              <li><span className="label">10:30am:</span> Inside, bathroom and hand washing; Circle / Story</li>
              <li><span className="label">10:45am:</span> Snack</li>
              <li><span className="label">11:00am:</span> Free play / artistic activity</li>
              <li><span className="label">12:10pm:</span> Bathroom and clean up</li>
              <li><span className="label">12:30pm:</span> Second snack</li>
